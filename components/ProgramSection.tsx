              ...
              >
                <div className="h-48 overflow-hidden relative">
                  <img 
                    ...
                    alt={program.title} 
                    className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-700 transform-gpu group-hover:scale-110 img-high-quality"
              ...
              >
                ...
                <div className="h-64 md:h-80 relative">
                  <img 
                    ...
                    className="w-full h-full object-cover transform-gpu img-high-quality"
                    referrerPolicy="no-referrer"
                    decoding="async"
                    onError={(e) => {
