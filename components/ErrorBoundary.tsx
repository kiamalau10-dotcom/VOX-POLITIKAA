      ...
      return (
        <div className="min-h-screen flex items-center justify-center p-6 bg-zinc-950 text-white font-sans">
          <div className="max-w-md w-full p-10 rounded-[3rem] bg-zinc-900 border border-white/10 shadow-2xl text-center">
            <div className="w-20 h-20 bg-slate-900/20 rounded-3xl flex items-center justify-center mx-auto mb-8">
              <AlertCircle size={40} className="text-slate-900" />
            </div>
            ...
            <button 
              ...
              className="w-full flex items-center justify-center gap-3 bg-slate-900 text-white py-4 rounded-2xl font-black uppercase tracking-widest hover:bg-black transition-all active:scale-95"
            >
